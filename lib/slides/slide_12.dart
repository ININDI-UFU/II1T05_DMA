                  ...
                  Expanded(
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [
                          TextSpan(text: 'CPU livre para processar', style: TextStyle(color: Color(0xFF3FB950), fontWeight: FontWeight.w700)),
                          TextSpan(text: ' — DMA move dados em paralelo. Aquisição contínua sem perda de amostras.'),
                        ],
                      ),
                    ),
                  ),
    ...
    return Column(
      ...
      children: [
        _TimelineRow(
          ...
          blocks: [
            _TBlock('Processa dados', const Color(0xFF0D2818), const Color(0xFF3FB950), flex: 2),
            _TBlock('Algoritmo PID', const Color(0xFF0D2818), const Color(0xFF3FB950), flex: 2),
            _TBlock('WiFi', const Color(0xFF0D2818), const Color(0xFF3FB950), flex: 1),
          ],
        ),
        ...
        _TimelineRow(
          ...
          blocks: [
            _TBlock('ADC→RAM', const Color(0xFF0D1F33), const Color(0xFF58A6FF), flex: 1),
            _TBlock('ADC→RAM', const Color(0xFF0D1F33), const Color(0xFF58A6FF), flex: 1),
            _TBlock('ADC→RAM', const Color(0xFF0D1F33), const Color(0xFF58A6FF), flex: 1),
            _TBlock('ADC→RAM', const Color(0xFF0D1F33), const Color(0xFF58A6FF), flex: 1),
            _TBlock('ADC→RAM', const Color(0xFF0D1F33), const Color(0xFF58A6FF), flex: 1),
        ...
        _TimelineRow(
          ...
          labelColor: const Color(0xFF3FB950),
          blocks: [
            _TBlock('Aquisição contínua (sem interrupção da CPU)', const Color(0xFF0D2818), const Color(0xFF3FB950), flex: 5),
          ],
        ),
        ...
        ...blocks.map((b) => Expanded(
              ...
              child: Container(
                ...
                child: Text(b.label, textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 10, color: b.textColor, fontWeight: FontWeight.w600)),
              ),
            )),
      ],
    );
