    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _RevealBlock(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Analogia',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xFFF78166)),
                ),
                const SizedBox(height: 6),
                Container(
                  padding: const EdgeInsets.all(14),
                  decoration: BoxDecoration(
                    color: const Color(0xFF2D1600).withValues(alpha: 0.5),
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(color: const Color(0xFFF78166).withValues(alpha: 0.3)),
                  ),
                  child: const Text(
                    ...
                    style: TextStyle(fontSize: 14, color: Color(0xFF8B949E), fontStyle: FontStyle.italic),
                  ),
                ),
              ],
            ),
          ...
          const SizedBox(height: 20),
          // Step 4: Resumo visual
          _RevealBlock(
            visible: step >= 4,
            child: Container(
              padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(
                color: const Color(0xFF0D1F33).withValues(alpha: 0.6),
                borderRadius: BorderRadius.circular(10),
              ...
              child: Row(
                ...
                children: [
                  _miniBlock('Periférico', const Color(0xFFF78166)),
                  const Icon(Icons.arrow_forward, color: Color(0xFF58A6FF), size: 20),
                  _miniBlock('DMA Controller', const Color(0xFF3FB950)),
                  const Icon(Icons.arrow_forward, color: Color(0xFF58A6FF), size: 20),
                  _miniBlock('Memória (RAM)', const Color(0xFFD2A8FF)),
                ],
              ),
            ),
          ),
  ...
  Widget _buildSection(String title, Color titleColor, String body) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        Text(body, style: const TextStyle(fontSize: 15, color: Color(0xFFC9D1D9))),
      ],
    );
  }
