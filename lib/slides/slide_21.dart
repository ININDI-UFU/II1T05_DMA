...
class Slide21 extends StatelessWidget {
              ...
              child: SelectableText.rich(
                TextSpan(
                  ...
                  children: [
                    ...
                    _eq,
                    _val('115200\n'),
                    _key('board_build.flash_mode'),
                    _eq,
                    _val('qio\n'),
                    _key('board_build.f_cpu'),
                    _eq,
                    _val('240000000L\n'),
                  ],
                ),
  ...
  static const _eq = TextSpan(
    text: ' = ',
    style: TextStyle(color: Color(0xFF8B949E)),
  );
  static TextSpan _comment(String t) => TextSpan(
    text: t,
    style: const TextStyle(color: Color(0xFF6A9955)),
  );
  static TextSpan _keyword(String t) => TextSpan(
    text: t,
    style: const TextStyle(
  ...
  static TextSpan _key(String t) => TextSpan(
    text: t,
    style: const TextStyle(color: Color(0xFF58A6FF)),
  );
  static TextSpan _val(String t) => TextSpan(
    text: t,
